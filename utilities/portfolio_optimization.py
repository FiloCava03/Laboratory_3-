...
def mean_variance_portfolio(
    ...
    mean_var_ptf_weights = (1/risk_aversion * np.linalg.inv(cov_matrix) @ expected_returns -
                            ((B-risk_aversion)/(risk_aversion*A)) *(np.linalg.inv(cov_matrix)@ ones_vec) ) # !!! COMPLETE AS APPROPRIATE !!!
